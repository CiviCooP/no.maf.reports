...
function reports_civicrm_install() {
  return _reports_civix_civicrm_install();
}
...
function reports_civicrm_uninstall() {
  return _reports_civix_civicrm_uninstall();
}
...
function reports_civicrm_enable() {
  return _reports_civix_civicrm_enable();
}
...
function reports_civicrm_disable() {
  return _reports_civix_civicrm_disable();
}
...
function reports_civicrm_managed(&$entities) {
  return _reports_civix_civicrm_managed($entities);
}
